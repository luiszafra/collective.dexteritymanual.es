...
project = u'Manual del Desarrollador de Dexterity'
copyright = u'La comunidad Plone y otros contribuyentes particulares'
...
html_title = 'Manual del Desarrollador de Dexterity'
